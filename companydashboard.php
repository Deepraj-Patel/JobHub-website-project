            ...
            <div class="card-body">
                ...
                <table>
                    <tbody>
                        ...
                        <tr>
                            <td>Working Employees</td>
                            <td>:</td>
                            <td> <?php echo $row2['working'] ;  ?></td>
                        </tr>
                    </tbody>
                    
                </table>
                <div class="flex-btn">
                    <a href="cchangepassword.php" class="btn">change password</a>
                    
                    <a href="updatecompanydetails.php" class="btn">update details</a>
