...
if(!empty($_SESSION['uemail'])){
        ...
        $query1="SELECT * from applied_jobs where applicant_email='$em'
                                                 AND company_name='$cname' 
                                                 AND applied_post='$pst' ";
        ...
        if($count>0){
            ...
            $sql= "INSERT INTO applied_jobs values(NOW(),'$nm','$em','$cname',' $cpost',' ',' ')";
            if($conn->query($sql)===TRUE){
                ...
                echo '<script>alert("Something worng try again to apply");</script>';
              }
        }
}
else{
